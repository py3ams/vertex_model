...
if load_from_file_logical
   ...
   if cell_volume_distribution_type == 1
      
      cells.volume = mean_volume*ones(no_cells,1);
      
   elseif cell_volume_distribution_type == 2
   ...
   if growth_speed_distribution_type==1
   ...
   elseif growth_speed_distribution_type==2
      
      cell_growth_speeds_matrix =...
         [max(average_cell_growth_speeds(1)*(1+0.2*randn(10*max_no_cells,1)),...
         0.2*average_cell_growth_speeds(1)*ones(10*max_no_cells,1)) ...
         average_cell_growth_speeds(2)*ones(10*max_no_cells,1)];
