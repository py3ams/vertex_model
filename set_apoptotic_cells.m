function [cells,dead_chemical,stats] = set_apoptotic_cells(cells,...
	...
	apoptosis_concentration_threshold,apoptosis_prob_above_threshold,...
	apoptosis_prob_below_threshold,dead_chemical,delta_t,FEM_solve_logical,stats)
...
if apoptosis_concentration_dependent
	...
	new_apoptotic_cells = rand(length_cells,1)<probability_apoptosis&~cells.boundary_logical&cells.state~=3;
...
cells.target_area(apoptotic_cells) = 0.99*cells.target_area(apoptotic_cells);
...
cells.force_constants.perimeter(apoptotic_cells) =...
	1/0.99*cells.force_constants.perimeter(apoptotic_cells);
cells.force_constants.tension(apoptotic_cells) =...
	1/0.99*cells.force_constants.tension(apoptotic_cells);
