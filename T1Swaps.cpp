...
//                printf("%u %u \n",new_vertex_1_mi,new_vertex_2_mi);
...
//                   printf("%u \n",cell_with_same_edge_mi);
               ...
               if((cell_with_same_edge_found&&final_cells_per_vertex[current_vertex_global_ci]==3)||
                  ...
                  for(unsigned i=0;i<3;i++){
                     ...
                     if((cell_with_same_edge_found && temp_cell_1_mi!=current_cell_mi && temp_cell_1_mi!=cell_with_same_edge_mi) ||
                             (!cell_with_same_edge_found && temp_cell_1_mi!=current_cell_mi)){
...
//                      
//                      if((cell_with_same_edge_found && temp_cell_2_mi!=current_cell_mi && temp_cell_2_mi!=cell_with_same_edge_mi) ||
//                              (!cell_with_same_edge_found&&temp_cell_2_mi!=current_cell_mi)){
//                         
