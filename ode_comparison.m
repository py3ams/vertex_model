...
true_solution_initial_vars = load('Saves/ode_comparison/true_solution2/initial_save');
...
true_solution_vars = load('Saves/ode_comparison/true_solution2/final_save');
