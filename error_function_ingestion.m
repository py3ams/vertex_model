...
load Saves/cellular_production_and_ingestion_with_regular_proliferation_and_death/final_save
...
% error_function = sqrt(delta_t*sum((total_concentration-net_chemical).^2));
